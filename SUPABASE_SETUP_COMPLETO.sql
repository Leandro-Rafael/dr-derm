-- ============================================
-- SCHEMA COMPLETO DO DRDERM - SUPABASE
...
CREATE TABLE IF NOT EXISTS products (
  ...
  discount_duration VARCHAR(20) CHECK (discount_duration IN ('unlimited', 'month', 'week') OR discount_duration IS NULL),
...
-- Função para atualizar updated_at de avaliações
